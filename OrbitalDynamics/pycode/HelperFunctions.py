...
class Orbit:
    ...
    def __init__(self,
        ...
        # TODO: Define calculated values as properties
    ...
    def period(self):
        """
        Function for calculating the period of the orbit
        """
...
class Rocket:
    ...
    def __init__(self,
        ...
        self.mc = construction_mass
        self.mu = useful_mass

    # Define mass ratios as properties
    @property
    def mass(self):
        return self.mp + self.mc + self.mu

    @property
    def total_mr(self):
        return self.mass / (self.mass - self.mp)
    ...
    @property
    def construction_mr(self):
        return self.mc / (self.mc + self.mp)

    @property
    def propellant_mr(self):
        return self.mp / self.mass

    # Define methods useful for the rocket's propagation
    def impulse(self, deltaV: float):
        propellant_mass = self.mass * (1 - np.exp(-deltaV / (self.Isp * 9.81)))
        self.mp -= propellant_mass
